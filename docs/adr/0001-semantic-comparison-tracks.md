...
| ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Retained logs and replay     | Kafka documents persistent logs, retention after consumption, consumer-controlled offsets, and rewinding to re-consume. [Kafka design](https://kafka.apache.org/42/design/design/)                                                                                  |
| Kafka groups and parallelism | A partition is consumed by one member of a subscribing group at a time; position is an offset per partition. This bounds conventional group parallelism by partition count. [Kafka consumer position](https://kafka.apache.org/42/design/design/#consumer-position) |
